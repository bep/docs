...
1.  Uncheck the **Allow teams to use this chart** option. In the next step, you'll configure the RBAC of the catalog to make this Helm chart available for the team `models` to use.
...
1.  The UI opens the **Pipelines** section. Click **Upload pipeline**.
