...
Issue the following command to get the required packages installed on your Linode:
    ...
    apt-get install postfix postfix-mysql postfix-doc mysql-client mysql-server courier-authdaemon courier-authlib-mysql courier-pop courier-pop-ssl courier-imap courier-imap-ssl libsasl2-2 libsasl2-modules libsasl2-modules-sql sasl2-bin libpam-mysql openssl
...
![Setting the root password for MySQL on a Linode.](431-postfix-courier-mysql-01-mysql-root-password.png)

When prompted, select "No" for web-based administration.

![Declining web-based administration for the Postfix mail server on an Ubuntu 8.04 (Hardy) Linode.](432-postfix-courier-mysql-02-mail-server-type-4.png)
...
![Selecting the Postfix mail server configuration type on an Ubuntu 8.04 (Hardy) Linode.](433-postfix-courier-mysql-02-mail-server-type-2.png)
...
![Selecting the Postfix system mail name on an Ubuntu 8.04 (Hardy) Linode.](434-postfix-courier-mysql-02-mail-server-type-3.png)
...
- [Virtual Users And Domains With Postfix, Courier, MySQL And SquirrelMail (Ubuntu 8.04)](http://www.howtoforge.com/virtual-users-domains-postfix-courier-mysql-squirrelmail-ubuntu8.04)
