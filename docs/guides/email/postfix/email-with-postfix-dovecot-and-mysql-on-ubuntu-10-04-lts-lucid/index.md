...
![Setting the root password for MySQL on a Linode.](68-postfix-courier-mysql-01-mysql-root-password.png)
...
![Selecting the Postfix mail server configuration type on an Ubuntu 10.04 (Lucid) Linode.](69-postfix-courier-mysql-02-mail-server-type-2.png)
...
![Selecting the Postfix system mail name on an Ubuntu 10.04 (Lucid) Linode.](70-postfix-courier-mysql-02-mail-server-type-3.png)
