---
slug: deploying-terraria-with-marketplace-apps
author:
...
modified_by:
  name: Linode
title: "Deploy a Terraria Server with Marketplace Apps"
contributor:
  name: Linode
external_resources:
...
|-------------------|-----------------|
| **Select an Image** | Debian 9 is currently the only image supported by the Terraria Marketplace App, and it is pre-selected on the Linode creation page. *Required*. |
