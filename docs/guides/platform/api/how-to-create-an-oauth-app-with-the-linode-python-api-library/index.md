...
```file {title="~/linode-oauth-project/app.py"}
...
...
```file {title="~/linode-oauth-project/templates/base.html"}
<html>
<head>
...
```file {title="templates/configure.html"}
{% extends 'base.html' %}
{% block content %}
    <form method="POST">
        <div class='row'>
...
```file {title="templates/error.html"}
{% extends 'base.html' %}
{% block content %}
    <div class='row'>
...
```file {title="templates/success.html"}
{% extends 'base.html' %}
{% block content %}
    <div class='row'>
        <h1>Success!</h1>
