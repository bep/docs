---
slug: monitor-system-logs-with-logwatch-on-fedora-14
deprecated: true
author:
  name: Linode
  email: docs@linode.com
description: 'This guide will show you how to use the logwatch utility to monitor system logs, generate reports, and monitor failed login attempts, and more on Fedora 14.'
keywords: ["logwatch", "security", "logging", "audit"]
tags: ["monitoring","fedora"]
license: '[CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0)'
aliases: ['/server-monitoring/logwatch/fedora-14/','/uptime/monitoring/monitor-system-logs-with-logwatch-on-fedora-14/']
modified: 2013-10-01
modified_by:
  name: Linode
