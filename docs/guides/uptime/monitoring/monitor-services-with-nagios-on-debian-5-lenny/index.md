...
```file {title="/usr/local/nagios/etc/objects/contacts.cfg"}
define contact{
...
```file {title="/usr/local/nagios/etc/objects/commands.cfg"}
define command{
