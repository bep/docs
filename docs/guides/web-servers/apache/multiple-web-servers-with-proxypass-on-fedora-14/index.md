...
```file {title="/etc/httpd/conf.d/proxy.conf"}
...
![Website running under Apache on Fedora 14.](211-proxypass-apache-site.png)

Here's the site "www.secondsite.org" being served by lighttpd via ProxyPass:

![Website running under Lighttpd on Fedora 14.](212-proxypass-lighttpd-site.png)
...
![Web application running under a directory via lighttpd on Fedora 14](213-proxypass-lighttpd-directory.png)
