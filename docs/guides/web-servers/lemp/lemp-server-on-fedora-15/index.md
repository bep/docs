...
```file {title="/srv/www/www.example.com/public\\_html/index.html"}
<html>
<head>
...
```file {title="/etc/sysconfig/spawn-fcgi"}
FASTCGI_USER=nginx
FASTCGI_GROUP=nginx
