...
1.  Set up your DNS records for your domain. [Create a Domain Zone and an *A record*](/docs/guides/dns-manager/#add-a-domain-zone) assigned to your Linode's IP address. If you use Linode's name servers, review the [DNS Manager](/docs/guides/dns-manager/) guide for instructions.
