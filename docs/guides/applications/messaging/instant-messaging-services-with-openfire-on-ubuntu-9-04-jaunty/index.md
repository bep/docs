...
![Database type selection in Openfire setup on Ubuntu 9.04 (Jaunty).](473-openfire-ubuntu-9.04-03-database-selection.png)
...
![Profile storage selection in Openfire setup on Ubuntu 9.04 (Jaunty).](474-openfire-ubuntu-9.04-04-profile-settings.png)

Enter the email address of the default administrative user and select a strong password.

![Administrator account settings in Openfire setup on Ubuntu 9.04 (Jaunty).](475-openfire-ubuntu-9.04-05-admin-account-settings.png)
