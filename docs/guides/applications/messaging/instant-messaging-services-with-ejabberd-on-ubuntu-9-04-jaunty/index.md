...
-   XMPP takes advantage of ["SRV" DNS records](/docs/guides/dns-records-an-introduction/) to support the resolution of domains to the servers which provide DNS records.
...
```file {title="/etc/ejabberd/ejabberd.cfg"}
