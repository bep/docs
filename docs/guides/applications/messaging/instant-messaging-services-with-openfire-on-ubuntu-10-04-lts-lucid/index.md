...
![Database type selection in Openfire setup on Ubuntu 10.04 (Lucid).](399-openfire-ubuntu-10.04-03-database-selection.png)
...
![Profile storage selection in Openfire setup on Ubuntu 10.04 (Lucid).](400-openfire-ubuntu-10.04-04-profile-settings.png)

Enter the email address of the default administrative user and select a strong password.

![Administrator account settings in Openfire setup on Ubuntu 10.04 (Lucid).](401-openfire-ubuntu-10.04-05-admin-account-settings.png)
