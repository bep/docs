...
og_description: 'The Catalyst web framework is a contemporary Perl-based MVC (Model View Controller) which promotes efficient and rapid development, clear app logic, and more.'
